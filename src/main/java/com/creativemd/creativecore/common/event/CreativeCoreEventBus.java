...
public class CreativeCoreEventBus extends EventBus {
    ...
    public CreativeCoreEventBus() {
        if (FMLCommonHandler.instance().getEffectiveSide().isClient()) initClient();
        else initServer();
    }
    ...
    public void bindCreativeCoreCallHandler(CreativeCoreCallHandler callHandler) {
        if (this.EventList.containsKey(callHandler.getEventType())) this.EventList.remove(callHandler.getEventType());
    ...
    public void removeAllEventListeners() {
        ...
        EventList.clear();
        if (FMLCommonHandler.instance().getEffectiveSide().isClient()) removeTickEventClient();
        else removeTickEventServer();
    }
